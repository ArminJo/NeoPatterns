...
void setup() {
    ...
    UpperNeoPixelBar.ColorWipe(COLOR32_RED_QUARTER, 80, CLEAR_PATTERN_BEFORE, DIRECTION_DOWN);
...
void MultiPatterns(NeoPatterns *aLedsPtr) {
    ...
    if (LowerNeoPixelBar.TotalStepCounter != 0 || MiddleNeoPixelBar.TotalStepCounter != 0
        ...
        case 0:
            ...
            break;
        case 1:
            LowerNeoPixelBar.ColorWipe(COLOR32_GREEN_QUARTER, tInterval, CLEAR_PATTERN_BEFORE, DIRECTION_DOWN);
            ...
            break;
        case 2:
            LowerNeoPixelBar.ColorWipe(COLOR32_BLACK, tInterval, DO_NOT_CLEAR_PATTERN_BEFORE);
            UpperNeoPixelBar.ColorWipe(COLOR32_BLACK, tInterval, DO_NOT_CLEAR_PATTERN_BEFORE, DIRECTION_DOWN);
            break;
        case 3:
